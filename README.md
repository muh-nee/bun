...
<h1 align="center">Bun (trigger scan)</h1>
...
Bun is an all-in-one toolkit for JavaScript and TypeScript apps. It ships as a single executable called `bun`. Commit for a scan
